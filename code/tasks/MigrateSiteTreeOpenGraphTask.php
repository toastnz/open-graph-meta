 ...
 */
class MigrateSiteTreeOpenGraphTask extends BuildTask
{
    protected $title = 'Migrate Open Graph metadata from Page to SiteTree';
    ...
    public function run($request)
    {
        ...
        if (class_exists('Page')) {
            if (Page::has_extension('OpenGraphMeta')) {
                // Should we overwrite?
